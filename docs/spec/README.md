...
靜態 HTML 原型（**88 頁**，Phase 1–4 全模組，含正向／負向狀態），瀏覽器開啟 [index.html](../mockup/index.html)。

| Phase | 頁數 | 模組 |
|-------|------|------|
| Phase 1 財務核心 | 37 | AUTH, MD, GL, RPT, SYS |
| Phase 2 帳款收付 | 18 | AR, AP, 票據/兌現, 銀行批次, 匯兌 |
| Phase 3 業務整合 | 19 | 銷售/銷折, 採購/進折, 發票, 期末結帳 |
| Phase 4 進階合規 | 14 | 固資/年度結轉, 預算, 簽核, 財務分析 |
